...
import {ERC2981} from "@openzeppelin/contracts@5.2.0/token/common/ERC2981.sol";
...
contract BTBFinanceNFT is ERC721, ERC721Enumerable, ERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(address initialOwner)
        ERC721("Pixel Avatars", "PIXEL")
        Ownable(initialOwner)
    {
        // Initialize with IPFS metadata URI
        _baseTokenURI = "ipfs://bafybeih6sw7ddqbmquwbsb7zfcvhwgkgtixkmpqeed33cn4lhtl7cg2ejm/";
